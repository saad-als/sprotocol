...
function MessageBubble() {
    return (
        <>
            <div className="card container-md border-warning dotted-border position-relative">
            ...
            <div className="card container-md m-5 border-success dotted-border position-relative">
                <div className="card-body">
